...
### Busware EnOcean TCM515 USB/WiFi Stick
...
| Specialty | Description |
| ----- | ----- |
| Chip Set | [TCM515](https://www.enocean.com/en/product/tcm-515/), [Datasheet](https://www.enocean.com/wp-content/uploads/downloads-produkte/en/products/enocean_modules/tcm-515/data-sheet-pdf/TCM_515_Data_Sheet_Nov2020.pdf), [User Manual](https://busware.de/tiki-index.php?page=EUL), [Firmware/Web-Installer](https://install.busware.de/) |
| Protocol | ESP3 |
...
Where to buy?: https://shop.busware.de/product_info.php/products_id/66
...
2. Go to https://install.busware.de/ with e.g. Chrome or Microsoft Edge.
3. Choose the correct firmware (--> EnOcean TCM515 (EUL) | WiFi-bridge (Port 2325)).
   <br><img src="./Install_WiFi-Bridge.png" height=300>
4. Press connect and choose your COM port.
