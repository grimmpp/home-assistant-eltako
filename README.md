...
**240 device types** and **71 EnOcean Equipment Profiles** are supported, **60** of them can become a Home Assistant entity. The lists below are generated from the code, so they describe exactly this version &ndash; the **Help** page of the web ui shows the same for the version you run.
...
<details>
<summary><b>All 240 devices</b> &ndash; the hardware types the integration knows by name</summary>
...
<details>
<summary><b>All 71 EEPs</b> &ndash; what they are and where they can be used</summary>
