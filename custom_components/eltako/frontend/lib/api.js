...
export const WS = /** @type {const} @satisfies {Record<string, import("../types.js").WsCommand>} */ ({
  ...
  FRONTEND_VERSION: "eltako/frontend/version",
  ...
  DEVICE_ADD_UNKNOWN: "eltako/devices/add_unknown",
  DEVICE_UPDATE: "eltako/devices/update",
  DEVICE_REMOVE: "eltako/devices/remove",
  DEVICE_REMOVE_ALL: "eltako/devices/remove_all",
  CONFIG_EXPORT: "eltako/config/export",
  CONFIG_REMOVE_ALL: "eltako/config/remove_all",
  STANDALONE_CONFIG_LIST: "eltako/standalone/configurations/list",
  STANDALONE_CONFIG_IMPORT: "eltako/standalone/configurations/import",
  STANDALONE_CONFIG_EXPORT: "eltako/standalone/configurations/export",
  STANDALONE_CONFIG_SWITCH: "eltako/standalone/configurations/switch",
  STANDALONE_CONFIG_SAVE: "eltako/standalone/configurations/save",
  STANDALONE_CONFIG_LOAD: "eltako/standalone/configurations/load",
  STANDALONE_CONFIG_LOAD_CONTENT: "eltako/standalone/configurations/load_content",
  STANDALONE_CONFIG_LOAD_EMPTY: "eltako/standalone/configurations/load_empty",
  STANDALONE_CONFIG_DETAILS: "eltako/standalone/configurations/details",
  STANDALONE_CONFIG_STORAGE: "eltako/standalone/configurations/storage",
  STANDALONE_CONFIG_DELETE: "eltako/standalone/configurations/delete",
  DEVICE_TEACH_IN: "eltako/devices/teach_in",
  DEVICE_SENDER_GATEWAY: "eltako/devices/sender_gateway",
  ...
  BUS_PROGRAM_GATEWAY: "eltako/bus/program_gateway",
  BUS_DELETE_MEMORY_LINE: "eltako/bus/delete_memory_line",
  ...
  PNP_CANCEL: "eltako/plug_and_play/cancel",
  ...
  LOG_IMPORT: "eltako/telegram_log/import",
