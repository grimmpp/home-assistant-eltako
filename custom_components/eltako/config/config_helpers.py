...
from ..const import (CONF_AREA, CONF_BASE_ID, CONF_DEPRECATED_ENABLE_FRONTEND,
                     ...
                     CONF_TIMESERIES_URL, CONF_LOG_LEVEL, DATA_ELTAKO, DATA_SETTINGS_OVERRIDES,
                     DATA_UI_GATEWAYS, DOMAIN,
...
DEFAULT_GENERAL_SETTINGS = {
    ...
    # empty: the level of the 'eltako' logger stays what Home Assistant configures
    CONF_LOG_LEVEL: '',
